// filepath: c:\Users\DELL\spanishLearningTool\verbs.js
export const verbs = [
  {
    english: "to live",
    spanish: "vivir",
    type: "regular",
    memoryTip: "Think of 'vivir' as 'vivid'—to live vividly.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "comer",
    type: "regular",
    memoryTip: "Comer sounds like 'consume'—to eat.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "hablar",
    type: "regular",
    memoryTip: "Hablar sounds like 'blah blah'—to speak.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "tener",
    type: "irregular",
    memoryTip: "Tener is used for possession and age.",
    conjugations: {
    ...
    examples: [
      "I have (Yo tengo)",
      "He had (Él tuvo)",
      "We will have (Nosotros tendremos)"
    ]
  },
  {
    english: "to go",
    spanish: "ir",
    type: "irregular",
    memoryTip: "Ir is highly irregular. Think 'voy' as 'I go'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "ser",
    type: "irregular",
    memoryTip: "Ser is for permanent traits, origin, time.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "estar",
    type: "irregular",
    memoryTip: "Estar is for location, feelings, temporary states.",
    conjugations: {
    ...
    spanish: "hacer",
    type: "irregular",
    memoryTip: "Hacer is used for 'to do' and 'to make'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "querer",
    type: "irregular",
    memoryTip: "Querer is also used for 'to love' in some contexts.",
    conjugations: {
    ...
    examples: [
      "I want (Yo quiero)",
      "They wanted (Ellos quisieron)",
      "We will want (Nosotros querremos)"
    ]
  },
  {
    ...
    spanish: "saber",
    type: "irregular",
    memoryTip: "Saber is for facts and information.",
    conjugations: {
    ...
    examples: [
      "I know (Yo sé)",
      "He knew (Él supo)",
      "We will know (Nosotros sabremos)"
    ]
  },
  {
    ...
    spanish: "conocer",
    type: "irregular",
    memoryTip: "Conocer is for being familiar with people or places.",
    conjugations: {
    ...
    examples: [
      "I know (Yo conozco)",
      "She met (Ella conoció)",
      "We will know (Nosotros conoceremos)"
    ]
  },
  {
    english: "to put",
    spanish: "poner",
    type: "irregular",
    memoryTip: "Poner is used for 'to put' or 'to place'.",
    conjugations: {
    ...
    examples: [
      "I put (Yo pongo)",
      "He put (Él puso)",
      "We will put (Nosotros pondremos)"
    ]
  },
  {
    english: "to leave",
    spanish: "salir",
    type: "irregular",
    memoryTip: "Salir is used for 'to leave' or 'to go out'.",
    conjugations: {
    ...
    examples: [
      "I leave (Yo salgo)",
      "They left (Ellos salieron)",
      "We will leave (Nosotros saldremos)"
    ]
  },
  {
    english: "to bring",
    spanish: "traer",
    type: "irregular",
    memoryTip: "Traer is used for 'to bring'.",
    conjugations: {
    ...
    examples: [
      ...
      "We will bring (Nosotros traeremos)"
    ]
  },
  {
    english: "to see",
    spanish: "ver",
    type: "irregular",
    memoryTip: "Ver is used for 'to see'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "dar",
    type: "irregular",
    memoryTip: "Dar is used for 'to give'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "llegar",
    type: "regular",
    memoryTip: "Llegar means 'to arrive'—think 'leg' arrives at the destination.",
    conjugations: {
    ...
    examples: [
      ...
      "We will arrive (Nosotros llegaremos)"
    ]
  },
  {
    english: "to write",
    spanish: "escribir",
    type: "regular",
    memoryTip: "Escribir looks like 'scribe'—to write.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "leer",
    type: "regular",
    memoryTip: "Leer looks like 'leer' in English—think 'to read'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "abrir",
    type: "regular",
    memoryTip: "Abrir is like 'abrir' a door—'to open'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "cerrar",
    type: "irregular",
    memoryTip: "Cerrar is a stem-changing verb: e→ie in present.",
    conjugations: {
    ...
    examples: [
      "I close (Yo cierro)",
      "She closed (Ella cerró)",
      "We will close (Nosotros cerraremos)"
    ]
  },
  {
    english: "to return",
    spanish: "volver",
    type: "irregular",
    memoryTip: "Volver is a stem-changing verb: o→ue in present.",
    conjugations: {
    ...
    examples: [
      "I return (Yo vuelvo)",
      "He returned (Él volvió)",
      "We will return (Nosotros volveremos)"
    ]
  },
  {
    english: "to sleep",
    spanish: "dormir",
    type: "irregular",
    memoryTip: "Dormir is a stem-changing verb: o→ue in present.",
    conjugations: {
    ...
    examples: [
      ...
      "We will sleep (Nosotros dormiremos)"
    ]
  },
  {
    english: "to play",
    spanish: "jugar",
    type: "irregular",
    memoryTip: "Jugar is a stem-changing verb: u→ue in present.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "perder",
    type: "irregular",
    memoryTip: "Perder is a stem-changing verb: e→ie in present.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "encontrar",
    type: "irregular",
    memoryTip: "Encontrar is a stem-changing verb: o→ue in present.",
    conjugations: {
    ...
    examples: [
      "I find (Yo encuentro)",
      "He found (Él encontró)",
      "We will find (Nosotros encontraremos)"
    ]
  },
  {
    ...
    spanish: "entender",
    type: "irregular",
    memoryTip: "Entender is a stem-changing verb: e→ie in present.",
    conjugations: {
      ...
      "Future Perfect": ["habré entendido", "habrás entendido", "habrá entendido", "habremos entendido", "habréis entendido", "habrán entendido"],
    ...
    examples: [
      ...
      "We will understand (Nosotros entenderemos)"
    ]
  },
  {
    english: "to ask",
    spanish: "preguntar",
    type: "regular",
    memoryTip: "Preguntar is used for asking questions.",
    conjugations: {
    ...
    examples: [
      ...
      "We will ask (Nosotros preguntaremos)"
    ]
  },
  {
    english: "to answer",
    spanish: "responder",
    type: "regular",
    memoryTip: "Responder is used for answering or responding.",
    conjugations: {
    ...
    examples: [
      ...
      "She answered (Ella respondió)",
      "We will answer (Nosotros responderemos)"
    ]
  },
  {
    english: "to help",
  ...
  },
  {
    ...
    spanish: "caminar",
    type: "regular",
    memoryTip: "Caminar means 'to walk'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "llamar",
    type: "regular",
    memoryTip: "Llamar means 'to call'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "estudiar",
    type: "regular",
    memoryTip: "Estudiar means 'to study'.",
    conjugations: {
    ...
    examples: [
      "I study (Yo estudio)",
      "She studied (Ella estudió)",
      "We will study (Nosotros estudiaremos)"
    ]
  },
  {
    english: "to listen",
    spanish: "escuchar",
    type: "regular",
    memoryTip: "Escuchar means 'to listen'.",
    conjugations: {
  ...
  },
  {
    ...
    spanish: "enseñar",
    type: "regular",
    memoryTip: "Enseñar means 'to teach'.",
    conjugations: {
    ...
    examples: [
      "I teach (Yo enseño)",
      "She taught (Ella enseñó)",
      "We will teach (Nosotros enseñaremos)"
    ]
  },
  {
    english: "to draw",
    spanish: "dibujar",
    type: "regular",
    memoryTip: "Dibujar means 'to draw'.",
    conjugations: {
    ...
    examples: [
      "I draw (Yo dibujo)",
      "He drew (Él dibujó)",
      "We will draw (Nosotros dibujaremos)"
    ]
  },
  {
    english: "to cook",
    spanish: "cocinar",
    type: "regular",
    memoryTip: "Cocinar means 'to cook'.",
    conjugations: {
    ...
    examples: [
      "I cook (Yo cocino)",
      "She cooked (Ella cocinó)",
      "We will cook (Nosotros cocinaremos)"
    ]
  },
  {
    english: "to swim",
  ...
  },
  {
    ...
    spanish: "bailar",
    type: "regular",
    memoryTip: "Bailar means 'to dance'.",
    conjugations: {
    ...
    examples: [
      ...
      "We will dance (Nosotros bailaremos)"
    ]
  },
  {
    english: "to travel",
    spanish: "viajar",
    type: "regular",
    memoryTip: "Viajar means 'to travel'.",
    conjugations: {
  ...
  },
  {
    ...
    examples: [
      "I pay (Yo pago)",
      "She paid (Ella pagó)",
      "We will pay (Nosotros pagaremos)"
    ]
  },
  {
    english: "to forget",
    spanish: "olvidar",
    type: "regular",
    memoryTip: "Olvidar means 'to forget'.",
    conjugations: {
    ...
    examples: [
      "I forget (Yo olvido)",
      "He forgot (Él olvidó)",
      "We will forget (Nosotros olvidaremos)"
    ]
  },
  {
    english: "to remember",
    spanish: "recordar",
    type: "irregular",
    memoryTip: "Recordar is a stem-changing verb: o→ue in present.",
    conjugations: {
    ...
    examples: [
      ...
      "She remembered (Ella recordó)",
      "We will remember (Nosotros recordaremos)"
    ]
  },
  {
    english: "to change",
    spanish: "cambiar",
    type: "regular",
    memoryTip: "Cambiar means 'to change'.",
    conjugations: {
    ...
    examples: [
      "I change (Yo cambio)",
      "He changed (Él cambió)",
      "We will change (Nosotros cambiaremos)"
    ]
  },
  {
    english: "to finish",
    spanish: "terminar",
    type: "regular",
    memoryTip: "Terminar means 'to finish' or 'to end'.",
    conjugations: {
    ...
    examples: [
      "I finish (Yo termino)",
      "She finished (Ella terminó)",
      "We will finish (Nosotros terminaremos)"
    ]
  },
  {
    english: "to begin",
    spanish: "empezar",
    type: "irregular",
    memoryTip: "Empezar is a stem-changing verb: e→ie in present.",
    conjugations: {
